...
Version Version::SupportedMediawiki = Version(SMUGGLE_SUPPORTED_MEDIAWIKI_VERSION);
...
Version::Version()
{
    ...
    this->major = 0;
    this->minor = 0;
    this->versionType = VersionType_Unknown;
    this->revision = 0;
    this->patch = 0;
}
...
bool Smuggle::operator!=(Version &a, Version &b)
{
    return !a.IsEqual(&b);
}
